...
$m\bar$ = argmin_$m\geq 0 \sqrt{\int_{[a,\infty[\cap D} |\sigma_m -\sigma^b|^2}dS$\\\\
\begin{itemize}
  \item $\sigma_m$ will interpolate the input data points when n = 2.
  \item $\sigma_m\bar$ has the asymptotic behavior that beast matches our function on the estimation interval. 
