...
First, we will study numerical methods of Stochastic Differential Equations (SDE). 
 ...
 \begin{equation}\label{Stochastic Differential Equation}
 dS_t &=& \mu(S_t)dt+\sigma(S_t)dW_t  
 S_0 = s_0
 \end{equation}
For the numerical solutions we will assume drift $\mu$ and diffusion $\sigma$ coeficients are constants. Now Euler Muruyama method can be used to model asset price. \\
 \indent By studying numberical solutions of SDE's, we will have better understanding toward the theory of SDE. 
...
\section{Method used to solve our Problem}
...
\end{equation} 
 First, we will obtain the data from Google Finance and Yahoo Finance. Algorithms 1, 2 and 3 show the process how to get Stock Prices.
